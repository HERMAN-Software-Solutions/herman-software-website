              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-navy/5 text-heading">
                    ...
                    <div>
                      <p className="text-body-sm font-semibold text-heading">Address</p>
                      <p className="text-body-sm text-foreground">{siteConfig.address}</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-navy/5 text-heading">
                    ...
                    <div>
                      <p className="text-body-sm font-semibold text-heading">Email</p>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-body-sm font-semibold text-heading">Phone</p>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-body-sm font-semibold text-heading">Office Hours</p>
                      <p className="text-body-sm text-foreground">{siteConfig.officeHours}</p>
                    </div>
                  </div>
                </div>
              </div>
