...
export function Footer() {
  ...
  return (
    <footer className="bg-navy-dark text-white">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-lg font-bold leading-tight tracking-tight text-white">
                    {settings?.siteName || "HERMAN"}
                  </div>
                  <div className="text-[10px] font-light uppercase tracking-[3px] text-gray-medium">
                    Software Solutions
                  </div>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              {settings?.linkedin && (
                <a href={settings.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="rounded-md p-2 text-gray-medium hover:bg-navy-dark hover:text-teal transition-colors">
              ...
              {settings?.twitter && (
                <a href={settings.twitter} target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="rounded-md p-2 text-gray-medium hover:bg-navy-dark hover:text-teal transition-colors">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {settings?.facebook && (
                <a href={settings.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="rounded-md p-2 text-gray-medium hover:bg-navy-dark hover:text-teal transition-colors">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Newsletter */}
      <div className="border-t border-navy py-10">
        <div className="container-site">
          <div className="mx-auto max-w-md text-center">
            <h4 className="mb-2 text-lg font-semibold text-white">Stay Updated</h4>
            <p className="mb-5 text-body-sm text-gray-medium">
              Get insights, tips, and company updates delivered to your inbox.
            </p>
            <NewsletterForm />
          </div>
        </div>
      ...
      <div className="border-t border-navy">
        <div className="container-site flex flex-col items-center justify-between gap-4 py-4 text-center sm:flex-row sm:text-left">
          <p className="text-body-sm text-gray-medium">
            Last updated: May 2026 &nbsp;|&nbsp; © {new Date().getFullYear()} {settings?.siteName || "HERMAN Software Solutions Limited"}. All rights reserved.
          </p>
          <div className="flex gap-4">
            <a href="/privacy-policy" className="text-body-sm text-gray-medium hover:text-teal transition-colors">Privacy Policy</a>
            <a href="/terms-of-service" className="text-body-sm text-gray-medium hover:text-teal transition-colors">Terms</a>
            <a href="/sitemap.xml" className="text-body-sm text-gray-medium hover:text-teal transition-colors">Sitemap</a>
          </div>
        </div>
      </div>
    </footer>
